...
- **Verify PR test plan items after CI passes (2026-03-07)**: After CI passes on a PR, verify each test plan checkbox item and check them off using `gh api` before suggesting the PR is ready to merge. Don't leave unchecked items in the PR body.
